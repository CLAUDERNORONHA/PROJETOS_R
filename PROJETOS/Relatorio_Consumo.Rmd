---
title: "Bebidas - Consumo"
   
   
   #Colocar um baner  Colocar o simbolo do | pipe depois do title 
   #![](https://i.imgur.com/HsiOIdf.png){width=500px style='display: block: margin:0 auto:'}
   
   
author: "Clauder Noronha"
...
output:
     html_document:
      ...
      # includes:
       ...
       #logo
       includes:
          in_header: "baner.html"
       
       theme: flatly
       number_sections: yes
       toc: yes #cria um sumario
       toc_float:
         collapsed: yes
         smooth_scroll: no
...
### Ordenado a variável "Alcool"

Colocar as categorias em uma ordem lógica (nenhum consumo, duas canecas e quatro canecas)
vai facilitar a visulização dos dados no gráfico.
...
* [GitHub](https://github.com/CLAUDERNORONHA/PROJETO)  
* [Linkedin](https://www.linkedin.com/in/clauder-noronha-912b6655/)
